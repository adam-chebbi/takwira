  ...
  return (
    <div className="pt-40 pb-20 px-6 md:px-12 max-w-4xl mx-auto space-y-12">
      <div className="space-y-4">
        <h1 className="text-5xl font-display font-black uppercase tracking-tight text-pl-purple">Politique de confidentialité</h1>
      ...
      <div className="prose max-w-none space-y-8 text-text-secondary font-medium leading-relaxed">
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-pl-purple border-l-4 border-accent-green pl-4">1. Collecte des données</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-pl-purple border-l-4 border-accent-green pl-4">2. Utilisation des données</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-pl-purple border-l-4 border-accent-green pl-4">3. Partage des données</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-pl-purple border-l-4 border-accent-green pl-4">4. Sécurité</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-pl-purple border-l-4 border-accent-green pl-4">5. Vos droits</h2>
          <p>
