  ...
  return (
    <div className="pt-40 pb-20 px-6 md:px-12 max-w-4xl mx-auto space-y-12">
      <div className="space-y-4">
        <h1 className="text-5xl font-display font-black uppercase tracking-tight text-white">Conditions d'utilisation</h1>
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-text-secondary font-medium leading-relaxed">
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-white border-l-4 border-accent-green pl-4">1. Acceptation des conditions</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-white border-l-4 border-accent-green pl-4">2. Description du service</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-white border-l-4 border-accent-green pl-4">3. Comptes utilisateurs</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-white border-l-4 border-accent-green pl-4">4. Réservations et Annulations</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-display font-black uppercase tracking-tight text-white border-l-4 border-accent-green pl-4">5. Responsabilité</h2>
          <p>
